...
void StaticMeshRenderingData::SetMesh(const SharedObjectPtr<StaticMesh>& mesh, uint8 lod, PassKey<StaticMesh>)
{
    _owningMesh = mesh;
...
SharedObjectPtr<StaticMesh> StaticMeshRenderingData::GetMesh() const
{
