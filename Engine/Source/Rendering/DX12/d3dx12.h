...
struct CD3DX12_PIPELINE_STATE_STREAM_PARSE_HELPER : public ID3DX12PipelineParserCallbacks
{
    ...
    virtual void FlagsCb(D3D12_PIPELINE_STATE_FLAGS Flags) override
    {PipelineStream.Flags = Flags;}
    virtual void NodeMaskCb(UINT NodeMask) override
    ...
    virtual void VSCb(const D3D12_SHADER_BYTECODE& VS) override
    {PipelineStream.VS = VS;}
    virtual void GSCb(const D3D12_SHADER_BYTECODE& GS) override
    ...
    virtual void HSCb(const D3D12_SHADER_BYTECODE& HS) override
    {PipelineStream.HS = HS;}
    virtual void DSCb(const D3D12_SHADER_BYTECODE& DS) override
    {PipelineStream.DS = DS;}
    virtual void PSCb(const D3D12_SHADER_BYTECODE& PS) override
    {PipelineStream.PS = PS;}
    virtual void CSCb(const D3D12_SHADER_BYTECODE& CS) override
    ...
    virtual void SampleDescCb(const DXGI_SAMPLE_DESC& SampleDesc) override
    {PipelineStream.SampleDesc = SampleDesc;}
    virtual void SampleMaskCb(UINT SampleMask) override
    ...
    virtual void ErrorBadInputParameter(UINT) override
    {}
    virtual void ErrorDuplicateSubobject(D3D12_PIPELINE_STATE_SUBOBJECT_TYPE) override
    {}
    virtual void ErrorUnknownSubobject(UINT) override
    {}
